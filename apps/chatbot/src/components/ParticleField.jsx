...
// Ported from public/background.jsx — particle / neural-network background canvas
// with subtle parallax + mouse pull. Default mode "neural", dark theme.
export default function ParticleField({
  ...
  useEffect(() => {
    ...
    function onLeave() { mouseRef.current.has = false; }
